        ...
        return(
            <React.Fragment>
                ...
                <div onChange={this.costFilter}>
                    ...
                    <label className="radio">
                        <input type="radio" value="3001,6000" name="cost"/>Rs 3000-6000
                    </label>
                    <label className="radio">
                        <input type="radio" value="6001,12000" name="cost"/>Rs 6000-12000
                    </label>
                    <label className="radio">
                        <input type="radio" value="12001,18000" name="cost"/>Rs 12000-18000
                    </label>
                </div>
            </React.Fragment>
        )
